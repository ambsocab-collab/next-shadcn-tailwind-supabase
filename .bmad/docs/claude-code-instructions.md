...
**IMPORTANT:** When analyzing the project or searching for context, **COMPLETELY IGNORE** any content located within:
- `docs/.ignorar-contenido`

Do not read, index, or reference files in this directory under any circumstances.